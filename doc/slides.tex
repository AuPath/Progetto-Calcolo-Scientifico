...
\begin{frame}
	...
	\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
		...
		\column{.5\textwidth} 
		Qui parliamo velocemente della FFT
		\begin{enumerate}
			\item Utilizziamo numpy.fft
			\item Implementazione sottostante scritta in linguaccio C.
			\item Costo computazionale: $O(n^2log(n))$
		\end{enumerate}
		
		\column{.5\textwidth} 
		Qui parliamo velocemente della Custom DCT
		\begin{enumerate}
			\item Implementata da noi in python
...
\frametitle{Algoritmo}
	\lstinputlisting[language=Python, firstline=21, lastline=34]{../src/latex_dct2.py}
\end{frame}

\begin{frame}
\frametitle{Algoritmo}
	\lstinputlisting[language=Python, firstline=7, lastline=16]{../src/latex_dct2.py}
\end{frame}

\begin{frame}
\frametitle{Algoritmo}
	\lstinputlisting[language=Python, firstline=37, lastline=52]{../src/latex_dct2.py}
\end{frame}
...
\begin{frame}
\Huge{\centerline{Grazie per l'attenzione fra'}}
\end{frame}
