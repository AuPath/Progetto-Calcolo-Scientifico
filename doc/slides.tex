...
\begin{itemize}
	...
	\item Il risolutore addotato dipende dalla forma di $A$ (ad esempio utilizza Cholesky per matrici simmetriche e definite positive)
\end{itemize}
\end{frame}
...
\begin{enumerate}
\item \textit{numpy}: libreria utilizzata per leggere e gestire le matrice in memoria e per il calcolo scientifico
